...
private:
    void setWeightPtr()
    {
        ...
        attention_weights.attr_proj_o = weights_ptr[5];

        attn_layernorm_weights.gamma = weights_ptr[6];
        attn_layernorm_weights.beta = weights_ptr[7];
        ...
        ffn_layernorm_weights.gamma = weights_ptr[12];
        ffn_layernorm_weights.beta = weights_ptr[13];
...
//        weights_size[5] = hidden_units_ * 2;  //attr_seg_embed removed
        weights_size[5] = hidden_units_ * hidden_units_;
        weights_size[6] = hidden_units_;
        weights_size[7] = hidden_units_;
        weights_size[8] = hidden_units_ * inter_size_;
        weights_size[9] = inter_size_;
        weights_size[10] = hidden_units_ * inter_size_;
        weights_size[11] = hidden_units_;
